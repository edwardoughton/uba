...
def process_data(data):
    ...
    data['scenario'] = data['scenario'].replace(['low_2_2_2'], 'Low')
    data['scenario'] = data['scenario'].replace(['baseline_2_2_2'], 'Baseline')
    data['scenario'] = data['scenario'].replace(['high_2_2_2'], 'High')
    data['strategy'] = data['strategy'].replace(['3G_epc_microwave_baseline_baseline_baseline_baseline_baseline'], '3G (MW)')
    data['strategy'] = data['strategy'].replace(['3G_epc_fiber_baseline_baseline_baseline_baseline_baseline'], '3G (FB)')
    data['strategy'] = data['strategy'].replace(['4G_epc_microwave_baseline_baseline_baseline_baseline_baseline'], '4G (MW)')
...
def process_all_regional_data(data):
    ...
    """
    data = data[['GID_0', 'GID_id', 'GID_level', 'population', 'population_km2', 'area_km2']]
...
if __name__ == '__main__':
    ...
    path = os.path.join(DATA_RAW, 'podis', 'regional_results_technology_options.csv')
